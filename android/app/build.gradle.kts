...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "AUTH_TOKEN", "\"aiva-dev-token-2026\"")
    }
    ...
    buildTypes {
        release {
            ...
            buildConfigField("String", "WS_URL", "\"wss://your-domain.com/ws\"")
        }
        debug {
            isMinifyEnabled = false
            buildConfigField("String", "WS_URL", "\"ws://127.0.0.1:8765/ws\"")
        }
    }
    compileOptions {
